	...
	<view class="popup-bottom-box">
		...
		<view class="bot-con">
			<view class="od-box">
				...
				<view class="od-item flex-item">
					<view class="item-tip require">付款方式</view>
					<view class="item-right">
						<view class="pay-list" style="width: 100%; display: flex; flex-wrap: wrap;">
							<view style="border-radius: 50rpx;" class="pay-item" :class="payMethod == '微信' ? 'active' : ''" @click="payMethod = '微信'">
								<view class="image-wrapper"><image src="@/static/img/pay-icon1.png" mode="aspectFit"></image></view>
								微信
							</view>
							<view style="border-radius: 50rpx;" class="pay-item" :class="payMethod == '支付宝' ? 'active' : ''" @click="payMethod = '支付宝'">
								<view class="image-wrapper"><image src="@/static/img/pay-icon2.png" mode="aspectFit"></image></view>
								支付宝
							</view>
							<view style="border-radius: 50rpx;" class="pay-item" :class="payMethod == '余额' ? 'active' : ''" @click="payMethod = '余额'">
								<view class="image-wrapper"><image src="@/static/img/pay-icon3.png" mode="aspectFit"></image></view>
								余额
							</view>
							<view style="border-radius: 50rpx;" class="pay-item" :class="payMethod == '朋友代付' ? 'active' : ''" @click="payMethod = '朋友代付'">

				...
				<view style="margin-top: 20rpx;">
					...
					<view class="item-right">
						<view class="pay-list" style="width: 100%; display: flex; flex-wrap: wrap;">
							...
							<view class="pay-item" :style="payMethod == '支付宝' ? 'border:2rpx solid #F9B804;' : 'padding:11rpx;'" @click="payMethod = '支付宝'">
								<view class="image-wrapper"><image src="@/static/img/pay-icon2.png" mode="aspectFit"></image></view>
								支付宝
							</view>
							
							<view class="pay-item" :style="payMethod == '朋友代付' ? 'border:2rpx solid #F9B804;' : 'padding:11rpx;'" @click="payMethod = '朋友代付'">

					...
					<view class="card" >
						<template v-if="system == 'android'">
							<view class="slot-btn" @click="uploadPopup(1)">
								<u-image width="600rpx" border-radius="10" height="347rpx" :src="cert1_image +'?x-oss-process=image/resize,m_lfit,w_200,h_200'"
					...
					<view class="card">
						<view class="slot-btn" hover-class="slot-btn__hover" hover-stay-time="150">
							...
							<u-image width="600rpx" border-radius="10" height="347rpx"
								src="../../../static/img/zeng6.png" v-else></u-image>
						</view>
					</view>
				</view>
			</view>
					...
					<view class="card">
						<view class="slot-btn" hover-class="slot-btn__hover" hover-stay-time="150">
							<u-image width="600rpx" border-radius="10" height="347rpx" :src="cert2_image"
								v-if="cert2_image != '' && cert2_image != undefined"></u-image>
							<u-image width="600rpx" border-radius="10" height="347rpx"
								src="../../../static/img/zeng5.png" v-else></u-image>
						</view>
					</view>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getCard() {
					console.log('fawuFrom'+this.userid)
					console.log(uni.getStorageSync('fawuFrom'+this.userid))
					console.log(333)
			...
			submit() {
				if (this.cert1_image == '' || this.cert1_image == undefined) {
					...
					fawuData.cardface_image = this.cert1_image;
					fawuData.cardback_image = this.cert2_image;
					fawuData.card_image = '已上传';
					uni.setStorageSync('fawuFrom'+this.userid, fawuData);

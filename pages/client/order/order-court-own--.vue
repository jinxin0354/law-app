<template>
	<view class="content">
		<view class="item-top" :style="{ 'background-image': 'url(' + topImg + ')' }">
			<view class="item-admin">
		...
		<view class="item-main">
			<view class="main-top">
				<view class="top-left">
					<text style="font-size: 26rpx;">￥</text>399
				</view>
			...
			<view class="item-title">
				债权债务代理起诉方(套餐)一审+二审+执行
			</view>
			<view class="item-way">
				<text class="item-txt">分期付</text>
				<text class="item-txt">为你分忧</text>
				<text class="item-txt">效益归你</text>
			</view>
			<view class="item-bottom" @click="$refs.orderService.$refs.popupEnsure.open()">
				...
				<text class="bottom-txt">免费取消订单·隐私保护·保险保障·无理...</text>
		...
		<view class="od-box  od-boxs">
			...
			<view class="od-item marginbottom20">
                ...
                <view class="item-right">
                	<view class="service-list inline-list">
                		<view class="service-item active">投资人支付</view>
                	</view>
                </view>
					<!-- <view class="item-img">
						<image class="" src="@/static/img/right.png" mode="aspectFit"></image>
					</view> -->
					<!-- 	<view class="service-list inline-list">
						<view class="service-item" @click="bearFees = '投资人支付(不用还)'"
							:class="bearFees == '投资人支付(不用还)' ? 'active' : ''">
							投资人支付
							<image class="noback2" src="@/static/img/order-noback.png"></image>
						</view>
						<view class="service-item" @click="bearFees = '自费'" :class="bearFees == '自费' ? 'active' : ''">自费
						</view>
					</view>
			...
			<view class="od-item marginbottom20">
                ...
                <view class="item-right">
                	<view class="service-list inline-list">
                		<view class="service-item active" style="width: 100%; margin-right: 0;">{{ qiankuan }}</view>
                	</view>
                </view>
			</view>
			<template v-if="bearFees == '自费'">
				<!-- 	<view class="od-item marginbottom20">
					...
					<view class="item-right">
						<view class="service-list inline-list">
							<view class="service-item" :class="{ active: jindu == item.value_name }"
								v-for="(item, index) in info.list.jindu" @click="jindu = item.value_name">
								{{ item.value_name }}
							</view>
						</view>
						<view class="item-nav"></view>
				...
				<view class="od-item marginbottom20">
					...
					<view class="item-right">
						<view class="service-list inline-list">
							<view class="service-item" :class="{ active: self_ident == item.value_name }"
								v-for="(item, index) in info.list.self_ident" @click="self_ident = item.value_name">
								{{ item.value_name }}
							</view>
						</view>
						<view class="item-nav"></view>
				...
				<view class="od-item marginbottom20">
					...
					<view class="item-right">
						<view class="service-list inline-list">
							<view class="service-item" :class="{ active: dui_ident == item.value_name }"
								v-for="(item, index) in info.list.dui_ident" @click="dui_ident = item.value_name">
								{{ item.value_name }}
							</view>
						</view>
						<view class="item-nav"></view>
				...
				<view class="od-item marginbottom20">
					...
					<view class="item-right">
						<view class="service-list inline-list">
							<view class="service-item" :class="{ active: is_believe == 1 }" @click="is_believe = 1">否
							</view>
							<view class="service-item" :class="{ active: is_believe == 0 }" @click="is_believe = 0">是
							</view>
						</view>
						<view class="whyIcon"
							@click="jump('/pages/client/order/web-view', { url: 'http://zxgk.court.gov.cn/zhixing' })">
				...
				<view class="od-item marginbottom20">
					...
					<view class="item-right">
						<view class="service-list inline-list">
							<view class="service-item" :class="{ active: organization == item.value_name }"
								v-for="(item, index) in info.list.organization" @click="organization = item.value_name">
								{{ item.value_name }}
							</view>
						</view>
						<view class="item-nav"></view>
				...
				<view class="od-item marginbottom20">
					...
					<view class="item-right" @click="$refs.popupTake.open()">
						...
						<view class="item-nav" @click="$refs.popupTake.open()" v-else>
				...
				<view class="od-item marginbottom20">
					...
					<view class="item-right">
						<view class="service-list service-list-bottom inline-list">
							<view class="service-item marginbottom20" :class="{ active: offer == item.value_name }"
								@click="offer = item.value_name" v-for="(item, index) in offerList">
								{{ item.value_name }}
							</view>
					...
					<view class="item-right">
						<view class="fee-item flex">
							...
							<view class="service-list service-two" style="flex: 1;">
								...
								<view v-else class="service-item" style="width: 250rpx;"
				...
				<!-- <view class="fee-item flex">
							...
							<view class="fee-right" v-else>{{ moneyList.length > 0 ? moneyList[0].later_money : '' }}
							</view>
						</view>
					</view>
				</view> -->
				...
				<view class="od-item">
					...
					<view class="whyIcon" @click="$refs.orderCommonTip.$refs.popupTip.open()">
						<image src="@/static/img/why.png" mode="aspectFit"></image>
					</view>
				</view> -->
			</template>
			<template v-if="bearFees == '投资人支付(不用还)'">
				...
				<view class="od-item marginbottom20">
					<view class="item-tip">对方类型<image @click="$refs.identPopop.open()" src="@/static/img/order-ques.png" mode=""
				...
				<view class="od-item marginbottom20">
					<view class="item-tip">对方失信<image src="@/static/img/order-ques.png" mode=""
				style="width: 30rpx;height: 30rpx"></image></view>
					<view class="item-right">
						<view class="service-list inline-list">
							<view class="service-item active">否</view>
						</view>
						<view class="whyIcon"
							@click="jump('/pages/client/order/web-view', { url: 'http://zxgk.court.gov.cn/zhixing ' })">
							<image src="@/static/img/why.png" mode="aspectFit"></image>
				...
				<view class="od-item marginbottom20">
					<view class="item-tip">审理机构<image @click="$refs.organizationPopop.open()" src="@/static/img/order-ques.png" mode=""
				style="width: 30rpx;height: 30rpx"></image></view>
					<view class="item-right">
						<view class="service-list inline-list">
				...
				<view class="od-item marginbottom20">
					...
					<view class="item-tip require"><view class="center-box">
				...
				<view class="od-item ">
					<view class="item-tip">服务阶段<image src="@/static/img/order-ques.png" mode=""
				style="width: 30rpx;height: 30rpx"></image></view>
					<view class="item-right" @click="$refs.popupServiceStage.open()">
						<view class="service-list inline-list">
							<view class="service-item active" style="width: 100%; margin-right: 0;">{{ stage }}</view>
				...
				<view class="od-item">
					<view class="item-tip">服务报价</view>
					<view class="item-right">
						<view class="item-txt">投资人确定</view>
					</view>
				</view>
				<view class="od-item">
			...
			<order-popup-common title="服务阶段" @closePop="closePop('popupServiceStage')">
				<scroll-view class="popup-con" slot="popup-con" scroll-y="true">
					<view class="take-box">
						...
						<view class="service-list">
							<view class="service-item" style="width: 100%;" :class="{ active: stage == item }"
								v-for="(item, index) in stage_list" @click="stage = item">{{ item }}</view>
						</view>
					</view>
				</scroll-view>
				<view class="ok-box" slot="popup-btn"

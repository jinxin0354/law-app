					...
					<view class="why-box">
						<checkbox-group @change="resultChange">
							<view class="flex flex-horizontal flex-center-v">
								<label>
									<view class="flex flex-horizontal flex-center-v"  style="margin-top: -3rpx;">
								...
								<view class="flex flex-horizontal flex-center-v" style="margin-left: 15px;">
									...
									<view class="input-border">
										<input class="why-ipt" type="text" @input="inputChange($event,'case_money')" pattern="[0-9]*" v-model="case_money" :disabled="result.indexOf('checkValue1') == -1" placeholder="请输入" placeholder-class="placeholder" />
									</view>
								</view>
							</view>
							<view class="flex flex-horizontal flex-center-v item">
								...
								<view class="flex flex-horizontal flex-center-v" style="margin-left: 15px;">
									...
									<view class="input-border"><input class="why-ipt" pattern="[0-9]*" type="text" v-model="announce_money" @input="inputChange($event,'announce_money')" :disabled="result.indexOf('checkValue2') == -1" placeholder="请输入" placeholder-class="placeholder" /></view>
								</view>
							</view>
							<view class="flex flex-horizontal flex-center-v item">
								<label>
									<view class="flex flex-horizontal flex-center-v" style="margin-top: -7rpx;">
								...
								<view class="checkbox-right flex flex-horizontal">
									<view class=" flex flex-horizontal flex-center-v flex-1"  style="margin-left: 15px;">
										...
										<view class="input-border">
											<input class="why-ipt" type="text" pattern="[0-9]*" v-model="enquire" @input="inputChange($event,'enquire')" placeholder="请输入" :disabled="result.indexOf('checkValue3') == -1" placeholder-class="placeholder" />
										</view>
									</view>
								</view>
							</view>
							<view class="flex flex-horizontal flex-center-v item">
								<label>
									<view class="flex flex-horizontal flex-center-v" style="margin-top: -5rpx;">
